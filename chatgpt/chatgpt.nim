# ydbLock_demo.nim
# Nim-Client für YottaDB ydbLock_s()
...
# ydbLock_s aus der C-API (variadisch!)
proc ydbLock_s*(timeout_nsec: culonglong; namecount: cint): cint
...
when isMainModule:
  ...
  let rcA = ydbLock_s(1_000_000.culonglong, 2.cint,          # 1 ms, 2 Namen
  ...
  let rcB = ydbLock_s(1_000_000.culonglong, 2.cint,
  ...
  let rcU = ydbLock_s(0.culonglong, 0.cint)  # namecount=0 => alle Locks dieses Prozesses freigeben
  check(rcU, "unlock")
